...
>Note: ES modules require a server (not file://). Most modern browsers block module scripts loaded from the file system.

---

## License

This project is provided as-is for educational and community use. Wuthering Waves is a trademark of Kuro Games.
